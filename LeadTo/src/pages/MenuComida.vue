<template>
  <q-page class="bg-grey-2 menu-page">
    ...
    <q-page-sticky position="bottom-right" :offset="[18, 18]">
      ...
      >
        <q-badge v-if="totalItems" color="red" floating :label="totalItems" />
      </q-btn>
    </q-page-sticky>
    ...
    <q-dialog v-model="dialogVisible" position="bottom">
      <q-card class="carrito-card">
        ...
        <q-card-section class="row items-center justify-between carrito-header">
        ...
        <q-card-section class="carrito-body">
          <div v-if="!carrito.length" class="text-center text-grey-6 q-pa-lg">
